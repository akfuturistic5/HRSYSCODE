    ...
    <div class="row">
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <!-- end card header -->
                <div class="card-body">
                    <p class="text-muted">Use the <code>badge-soft-</code> class with below-mentioned variation to create
                        softer badge.</p>
                    <div class="d-flex flex-wrap gap-2">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use the <code>rounded-pill badge-soft-</code> class with the below-mentioned
                        variation to create a badge more rounded with a soft background.</p>
                    <div class="d-flex flex-wrap gap-2">

        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body card-buttons">
                    ...
                    <p class="mb-4">If you don’t fancy a border spinner, switch to the grow spinner. While it doesn’t
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body card-buttons">
                    ...
                    <p class="mb-4">Use <code>flexbox utilities</code>, <code>float utilities</code>, or <code>text
                            alignment</code> utilities to place spinners exactly where you need them in any situation.</p>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body card-buttons">
                    ...
                    <p class="mb-4">Use spinners within buttons to indicate an action is currently processing or taking
                        place.

        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body card-buttons">
                    ...
                    <button type="button" class="btn btn-outline-success me-1 mb-1" id="clear-toast-btn">Clear
                        Toast</button>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body card-buttons">
                    <p>you can use options like <code>showDuration</code>, <code>hideDuration</code>, <code>timeout</code>
                        for your

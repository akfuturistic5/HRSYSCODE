    ...
    <div class="col-md-12">
        <div class="card card-buttons">
            <div class="card-body">
                ...
                <p>Use an ordered or unordered list with linked list items to create a minimally styled breadcrumb. Use our
                    utilities to add additional styles as desired.</p>
        ...
        <div class="card card-buttons mb-0">
            <div class="card-body">
                ...
                <ol class="breadcrumb breadcrumb-colored bg-primary">
                    <li class="breadcrumb-item"><a href="javascript:void(0)" data-bs-original-title=""
                            title="">Home</a></li>
